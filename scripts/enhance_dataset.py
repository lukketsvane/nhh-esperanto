...
# File paths
INPUT_PATH = 'data/processed/nhh_esperanto_finalized_dataset.csv'
OUTPUT_PATH = 'data/processed/nhh_esperanto_enhanced_dataset.csv'
PARTICIPANTS_PATH = 'data/processed/nhh_esperanto_participants.csv'
CONVERSATIONS_PATH = 'data/processed/nhh_esperanto_conversations.csv'
MESSAGES_PATH = 'data/processed/nhh_esperanto_messages.csv'
DATA_DICTIONARY_PATH = 'data/processed/nhh_esperanto_data_dictionary.csv'
